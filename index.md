...
across every test, the `renv.lock` is not fully in sync with the
declared dependencies, and `boston_housing` is shipped as a verbatim
copy of [`MASS::Boston`](https://rdrr.io/pkg/MASS/man/Boston.html)
(documented in
