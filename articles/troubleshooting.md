...
**Solution:** Check for duplicated or linearly dependent predictors in
the auxiliary regression. Removing or combining offending variables
...
or running diagnostics on a representative sample to reduce computation
time.
...
can help determine the best approach for a given situation.
