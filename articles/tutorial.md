...
the `boston_housing` dataset bundled with the package.
...
```
    ...
    ## Weighted Residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -1.2297 -1.0001 -0.9925  0.9987  1.1131 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) -2.730740   0.319772   -8.54   <2e-16 ***
    ## lstat       -0.574826   0.005660 -101.56   <2e-16 ***
    ## rm           5.236735   0.041053  127.56   <2e-16 ***
    ## crim        -0.103099   0.002545  -40.52   <2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 1.004 on 502 degrees of freedom
    ## Multiple R-squared:  0.9967, Adjusted R-squared:  0.9967 
    ## F-statistic: 5.103e+04 on 3 and 502 DF,  p-value: < 2.2e-16
...
```
    ...
    ##           white breusch_pagan
    ## Model1 135.1481      24.34401
    ## Model2 135.1477      24.62192
