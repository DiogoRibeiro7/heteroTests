...
md("# Modern and Scalable Diagnostics",
   ...
   "2. **Tours the resampling and robust diagnostics** --- the rank-permutation",
...
md("## 5. Takeaways",
   ...
   "  sacrificing power.",
   "- **Use complementary lenses.** Rank-based and quantile-based tests detect",
   "  different departures; running more than one is cheap insurance.",
