...
The sweep covers 32 exported tests: 26 heteroscedasticity diagnostics and 6 with other nulls (arch, csdep, effect, form, spatial). 25 of the 26 heteroscedasticity tests fall within three Monte Carlo standard errors of the nominal 0.05.
