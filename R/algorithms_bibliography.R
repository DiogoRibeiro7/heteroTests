...
#' \emph{Econometrica}, 47(5), 1287--1294.
#'
#' Koenker, R. (1981).
#' A note on studentizing a test for heteroscedasticity.
#' \emph{Journal of Econometrics}, 17(1), 107--112.
#' doi:10.1016/0304-4076(81)90062-2
#'
#' Goldfeld, S. M., & Quandt, R. E. (1965).
...
#'
#' Cook, R. D., & Weisberg, S. (1983).
#' Diagnostics for heteroscedasticity in regression.
#' \emph{Biometrika}, 70(1), 1--10.
#' doi:10.1093/biomet/70.1.1
#'
#' O'Brien, R. G. (1979).
#' A general ANOVA method for robust tests of additive models for variances.
#' \emph{Journal of the American Statistical Association}, 74(368), 877--880.
#' doi:10.1080/01621459.1979.10481047
#'
#' Cameron, A. C., & Trivedi, P. K. (1990).
#' The information matrix test and its applied alternative hypotheses.
#' \emph{Working Paper}, University of California, Davis.
#'
#' Spearman, C. (1904).
...
#'
#' Cameron, A. C. (1991).
#' Regression based tests of heteroskedasticity in models where the variance depends on the mean
#' (Working Paper No. WP-379).
...
#'
#' @section Computational references:
